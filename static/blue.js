...
var metallist = ["/static/images/metal-cans.jpg"]
var householdmetallist = ["/static/images/household-metal.jpg"]
...
var all = ".ceramics, .styrofoam, .candy-wrapper, .plastic-toys, .paper, .newspaper, \
			...
			.paper-bags, .smooth-cardboard, .corrugated-cardboard, .metal, .household-metal"
...
var blue = ".plastic, .glass, .aluminum-foil, .drink-box, .metal, .household-metal"
...
function makeAllNames() {
	...
	makeNames(metallist, ".metal", "Metal")
	makeNames(householdmetallist, ".household-metal", "Household Metal")
		...
		drop: function( event, ui ) {
			if(ui.draggable.parent().is(blue)) {
				...
				if(ui.draggable.parent().hasClass("plastic")) {
					...
					var new_div_1 = $("<ul>")
					var new_div_2 = $("<li>")
					$(new_div).text("Plastic bottles, jugs, caps, lids, food containers, non food containers, packaging, and houseware")
					$(new_div_2).text("Yogurt, take out, tupperware, flower pots")
					$(new_div_1).append(new_div_2)
					$(new_div).append(new_div_1)
					...
					var new_div_1 = $("<ul>")
					var new_div_2 = $("<li>")
					$(new_div).text("Glass bottles and jars")
					$(new_div_2).text("Glassware from laboratories is recyclable under a separate program")
					$(new_div_1).append(new_div_2)
					$(new_div).append(new_div_1)
			   		$(".blue-title").append(new_div)
					...
					var new_div_1 = $("<ul>")
					var new_div_2 = $("<li>")
					$(new_div).text("Aluminum foil wrap and trays")
					$(new_div).append(new_div_1)
			   		$(".blue-title").append(new_div)
					...
					var new_div_1 = $("<ul>")
					var new_div_2 = $("<li>")
					$(new_div).text("Beverage cartons and drink boxes")
					$(new_div_2).text("Milk and juice")
					$(new_div_1).append(new_div_2)
					$(new_div).append(new_div_1)
			   		$(".blue-title").append(new_div)
				} else if (ui.draggable.parent().hasClass("metal")) {
					var item = metallist[metallist.indexOf(draggableId)]
					metallist.splice(metallist.indexOf(draggableId), 1)
					// Add correct to bin
					var new_div = $("<li>")
					var new_div_1 = $("<ul>")
					var new_div_2 = $("<li>")
					$(new_div).text("Metal cans")
					$(new_div_2).text("Tuna cans, empty aerosol cans, empty and dried-out paint cans with lids removed, for example")
					$(new_div_1).append(new_div_2)
					$(new_div).append(new_div_1)
			   		$(".blue-title").append(new_div)
				} else if (ui.draggable.parent().hasClass("household-metal")) {
					var item = householdmetallist[householdmetallist.indexOf(draggableId)]
					householdmetallist.splice(householdmetallist.indexOf(draggableId), 1)
					// Add correct to bin
					var new_div = $("<li>")
					var new_div_1 = $("<ul>")
					var new_div_2 = $("<li>")
					$(new_div).text("Household metal")
					$(new_div_2).text("Wire coat hangers, pots, pans, for example")
					$(new_div_1).append(new_div_2)
					$(new_div).append(new_div_1)
			   		$(".blue-title").append(new_div)
				}
